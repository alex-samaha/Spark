...
public class CareerPageCntl {
    ...
    public CareerPageCntl(Stage currentStage) {
    ...
    public void setupNavigationScene() {
        ...
        try {
            ...
            root = FXMLLoader.load(getClass().getResource("CareerPageUI.fxml"));
            ...
            mainStage.setTitle("Career Page");
            mainStage.show();
