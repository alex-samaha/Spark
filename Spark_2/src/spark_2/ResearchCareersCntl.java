 ...
 * @author ags12
 */
public class ResearchCareersCntl {
    ...
    public ResearchCareersCntl(Stage currentStage) {
    ...
    public void setupNavigationScene() {
        ...
        try {
            ...
            root = FXMLLoader.load(getClass().getResource("ResearchCareersUI.fxml"));
            ...
            mainStage.setTitle("Research Careers");
            mainStage.show();
